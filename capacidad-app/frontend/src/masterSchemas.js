...
export const MASTER_SCHEMAS_META = {
  ...
  SETUP_EXTRUSORAS: [
    ...
    { name: "CTE_DADO",              type: "decimal", required: false, label: "CTE DADO"              },
  ],

  // MEZCLAS queda casi deshabilitado: solo conserva la clave MEZCLA. Previsto
  // para reactivarse cuando se hagan cálculos basados en la mezcla.
  MEZCLAS: [
    { name: "MEZCLA", type: "string", required: true, label: "MEZCLA" },
  ],
};
